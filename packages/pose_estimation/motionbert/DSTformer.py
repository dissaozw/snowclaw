"""
DSTformer — Dual-stream Spatio-Temporal Transformer for 3D pose estimation.

Adapted from MotionBERT (https://github.com/Walter0807/MotionBERT).
License: MIT
"""
...
class Block(nn.Module):
    def __init__(self, dim, num_heads, mlp_ratio=4.0, mlp_out_ratio=1.0, qkv_bias=True, qk_scale=None,
...
class DSTformer(nn.Module):
    def __init__(self, dim_in=3, dim_out=3, dim_feat=256, dim_rep=512,
                 ...
                 drop_path_rate=0.0, norm_layer=nn.LayerNorm, att_fuse=True):
        super().__init__()
